...
const Footer = () => {
  ...
  return (
    <div className="mt-10 pb-8 flex flex-col items-center relative z-10">
      ...
      <div className="w-full flex flex-col md:flex-row items-center md:justify-between gap-6">
        ...
        <div className="flex gap-3 order-2 md:order-none">
          <a href="https://github.com/DRN-DevLarx"><i className="ri-github-fill ri-2x"></i></a>
          <a href="https://www.facebook.com/share/1AA8UGs6vg/"><i className="ri-facebook-fill ri-2x"></i></a>
          <a href="https://www.linkedin.com/in/darien-aguilar-2b406733a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"><i className="ri-linkedin-fill ri-2x"></i></a>
        </div>

        {/* Dock - paling bawah di mobile */}
        <div className="order-3 md:order-none mt-10 md:mt-0 md:mb-0">
          <Dock 
            items={items}
            panelHeight={30}
            baseItemSize={60}
